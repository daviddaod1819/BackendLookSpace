package com.cevonline.lookspace.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.cevonline.lookspace.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.cevonline.lookspace.repository.UserRepository.USERS_BY_EMAIL_CACHE);
